...
function enable_param() {
    ...
    $("#fixed_response_no").attr('disabled', false);
    $("#variable_response_no").attr('disabled', false);
    $("#bitwise_response_no").attr('disabled', false);
}

function addParamValueToResponse() {
    var param = $('#parameter').val();
    var command = document.getElementById("response").value;
