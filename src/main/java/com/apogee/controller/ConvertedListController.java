...
import com.apogee.model.ConvertedListModel;
 ...
 * @author admin
 */
@WebServlet(name = "ConvertedListController", urlPatterns = {"/ConvertedListController"})
public class ConvertedListController extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        ConvertedListModel model = new ConvertedListModel();
        try {
...
//            request.setAttribute("list", list);
            ...
            ArrayList<EnquiryBean> list = model.getAllConvertedEnquiries(source_search_id, status_search_id, ctx, role);
            request.setAttribute("list", list);
        }
        ...
        request.getRequestDispatcher("convertedlist").forward(request, response);
    }
